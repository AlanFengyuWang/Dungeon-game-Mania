...
public class LogicOrTest {
    ...
    ***/
    ...
    @Test
    public void basicLogicOrTest1() {
        /*** 
        * 1 switch connected to OR Door
        ***/
        ...
        DungeonResponse newDungeon =  dungeonStart.newGame("logic_test12", "Peaceful");
    ...
    public void basicLogicOrTest2() {
        ...
        ***/
        ...
        DungeonManiaController dungeonStart = new DungeonManiaController();
        // Create dungeon from exisitng json file
        DungeonResponse newDungeon =  dungeonStart.newGame("logic_test13", "Peaceful");
    ...
    public void basicLogicOrTest3() {
        ...
        ***/
        ...
        DungeonManiaController dungeonStart = new DungeonManiaController();
        // Create dungeon from exisitng json file
        DungeonResponse newDungeon =  dungeonStart.newGame("logic_test14", "Peaceful");
        ...
        player = newDungeon.getEntities().stream().filter(e -> e.getType().equals("player")).findFirst().orElse(null); //here it return null if it does not find anything
        oldPos = player.getPosition();
        // Opened since there is an activated switche
        assertEquals(oldPos, newPos);
        ...
        player = newDungeon.getEntities().stream().filter(e -> e.getType().equals("player")).findFirst().orElse(null); //here it return null if it does not find anything
        oldPos = player.getPosition();
        // Opened since there is at least 1 activated switch
        assertEquals(oldPos, newPos);
    }

    @Test
    public void basicLogicOrTest4() {
        /*** 
        * OR switch connected to Door
        ***/
        ...
        DungeonManiaController dungeonStart = new DungeonManiaController();
        // Create dungeon from exisitng json file
        DungeonResponse newDungeon =  dungeonStart.newGame("logic_test15", "Peaceful");
